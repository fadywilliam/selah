    ...
    <div class="box-header with-border">
        <h3 class="box-title">{{trans('admin.Editsaleoffer')}}</h3>
    ...
    <form action="{!! action('SaleoffersController@update_saleofferdetails') !!}?id=<?php echo $_GET['id'] ?>&myproperty_id=<?php echo $_GET['myproperty_id']; ?>" method="post" accept-charset="UTF-8" class="form-horizontal" enctype="multipart/form-data">
